About ansys-geometry-core-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ansys-geometry-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ansys-geometry-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ansys-geometry-core
# for installing globally
pixi global install ansys-geometry-core
```
...
It is possible to list all of the versions of `ansys-geometry-core` available on your platform:
...
```
pixi search ansys-geometry-core --channel conda-forge
```
